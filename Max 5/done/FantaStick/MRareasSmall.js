...
//                      by
//                 Martin Ritter
//                      2009                       // landscape sliderOnOff toggle isn't updating properly!!!!!!
//
...
if (jsarguments.length == 3)     {               //define number of fields
    dimX = jsarguments[1];
    dimY = jsarguments[2];
}
    
else if (jsarguments.length <= 1) {
    fields = 48;
    dimX = 6;
    dimY = 8;
    ...
    post("extra agrument dropped"); 
    post();
    post("----------------------");
    post();
    
}   
else if (jsarguments.length == 2)       {
    dimY = 8;
    post("agrument missing"); 
    post();
    post("dimY default = 8");
    post();
    post("----------------------");
...
/************************************************/
function outputMode(x)  {                               // integer of x/y coordinates

	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 545.0, 38.0, 27.0, 18.0 ],
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 499.0, 38.0, 27.0, 18.0 ],
					"outlettype" : [ "" ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 118.0, 95.0, 32.5, 18.0 ],
					"outlettype" : [ "int" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 6,
					"numoutlets" : 1,
					"patching_rect" : [ 240.0, 122.0, 86.5, 18.0 ],
					"outlettype" : [ "float" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 119.0, 147.0, 41.0, 16.0 ],
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 2,
					"patching_rect" : [ 118.0, 169.0, 46.0, 18.0 ],
					"outlettype" : [ "", "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 118.0, 121.0, 30.0, 18.0 ],
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 385.0, 272.0, 41.0, 16.0 ],
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 1,
					"patching_rect" : [ 103.0, 332.0, 174.0, 20.0 ],
					"outlettype" : [ "signal" ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 0 ],
					"hidden" : 0,
					"midpoints" : [ 554.5, 160.0, 267.5, 160.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 508.5, 155.5, 190.5, 155.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 249.5, 145.0, 394.5, 145.0 ]
				}

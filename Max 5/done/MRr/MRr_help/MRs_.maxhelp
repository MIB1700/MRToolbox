{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 694.0, 223.0, 512.0, 531.0 ],
		"bglocked" : 0,
		"defrect" : [ 694.0, 223.0, 512.0, 531.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 10.0,
					"patching_rect" : [ 420.0, 523.0, 74.0, 18.0 ],
					"id" : "obj-35",
					"numinlets" : 1,
					"fontname" : "Arial",
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"fontface" : 1,
					"fontsize" : 11.595187,
					"patching_rect" : [ 366.0, 477.0, 100.0, 20.0 ],
					"id" : "obj-36",
					"numinlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"types" : [  ],
					"patching_rect" : [ 379.0, 495.0, 100.0, 20.0 ],
					"id" : "obj-32",
					"numinlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 10.0,
					"patching_rect" : [ 234.0, 498.0, 108.0, 18.0 ],
					"id" : "obj-57",
					"numinlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 10.0,
					"patching_rect" : [ 232.0, 484.0, 114.0, 18.0 ],
					"id" : "obj-55",
					"numinlets" : 1,
					"fontname" : "Arial Bold"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 220.0, 478.0, 135.0, 40.0 ],
					"id" : "obj-58",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 361.0, 473.0, 140.0, 50.0 ],
					"id" : "obj-10",
					"numinlets" : 1
				}

{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 694.0, 223.0, 512.0, 524.0 ],
		"bglocked" : 0,
		"defrect" : [ 694.0, 223.0, 512.0, 524.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontface" : 1,
					"fontsize" : 11.595187,
					"patching_rect" : [ 369.0, 472.0, 100.0, 20.0 ],
					"id" : "obj-36",
					"numinlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 10.0,
					"patching_rect" : [ 430.0, 515.0, 74.0, 18.0 ],
					"id" : "obj-35",
					"numinlets" : 1,
					"fontname" : "Arial",
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"fontsize" : 11.5,
					"items" : [ "(Objects:)", ",", "send", ",", "receive", ",", "MRr_", ",", "MRs_", ",", "_nTbp", ",", "nTbp_" ],
					"types" : [  ],
					"patching_rect" : [ 382.0, 490.0, 100.0, 20.0 ],
					"id" : "obj-32",
					"numinlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 11.0,
					"patching_rect" : [ 383.0, 407.0, 90.0, 19.0 ],
					"id" : "obj-26",
					"numinlets" : 1,
					"fontname" : "Arial Bold"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 10.0,
					"patching_rect" : [ 351.0, 378.0, 159.0, 29.0 ],
					"id" : "obj-27",
					"numinlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "_MRr 56 @r anotherOne",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontsize" : 10.0,
					"patching_rect" : [ 362.0, 337.0, 122.0, 18.0 ],
					"id" : "obj-25",
					"numinlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 11.0,
					"patching_rect" : [ 188.0, 304.0, 70.0, 19.0 ],
					"id" : "obj-18",
					"numinlets" : 1,
					"fontname" : "Arial Bold"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 10.0,
					"patching_rect" : [ 156.0, 275.0, 159.0, 29.0 ],
					"id" : "obj-16",
					"numinlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 10.0,
					"patching_rect" : [ 237.0, 493.0, 108.0, 18.0 ],
					"id" : "obj-57",
					"numinlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 10.0,
					"patching_rect" : [ 235.0, 479.0, 114.0, 18.0 ],
					"id" : "obj-55",
					"numinlets" : 1,
					"fontname" : "Arial Bold"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 223.0, 473.0, 135.0, 40.0 ],
					"id" : "obj-58",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 364.0, 468.0, 140.0, 50.0 ],
					"id" : "obj-10",
					"numinlets" : 1
				}

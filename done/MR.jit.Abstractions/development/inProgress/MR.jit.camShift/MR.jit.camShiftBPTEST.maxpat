...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 198.0, 120.0, 18.0 ],
					"text" : "sub 320 240"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 167.0, 171.0, 123.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 154.0, 114.0, 34.0, 16.0 ],
					"text" : "close"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 61.0, 103.0, 56.0, 18.0 ],
					"text" : "qmetro 33"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 117.0, 114.0, 33.0, 16.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 61.0, 136.0, 52.0, 18.0 ],
					"text" : "jit.qt.grab"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 206.0, 238.5, 285.0, 100.0 ],
					"text" : "the first argument is the instance number (as always)\n\nthe second argument is the SEPARATE error catching abstraction that will be loaded! By default it's simply a \"through\" method. What comes in goes out, with no functionality!!!"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-3",
					"maxclass" : "bpatcher",
					"name" : "MR.jit.camShiftBP.maxpat",
					"numinlets" : 2,
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 61.0, 198.0, 125.0, 184.0 ],
					"varname" : "MR.jit.camShiftBP"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 70.5, 162.0, 176.5, 162.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-3::obj-10::obj-28" : [ "textbutton[1]", "textbutton", 0 ],
			"obj-3::obj-2::obj-12::obj-28" : [ "textbutton[2]", "textbutton", 0 ],
			"obj-1::obj-15::obj-28" : [ "textbutton[3]", "textbutton", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "MR.jit.camShiftBP.maxpat",
				"bootpath" : "/Users/MartinRitter/Documents/Music/Max6/MyToolbox/MR.jit Abstractions/inProgress/MR.jit.camShift",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "MRcv.jit.shift.draw.multi2_generic.maxpat",
				"bootpath" : "/Users/MartinRitter/Documents/Music/Max6/ScoreFollowing/summer2012/Martin",
				"patcherrelativepath" : "../../../../ScoreFollowing/summer2012/Martin",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{

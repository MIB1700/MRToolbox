					...
					rotate,  scale, doRender, renderType, text, font, fontsize)
{
	...
	this.renderType	= renderType; //points, lines, line_loop, line_strip, triangles, triangle_strip, triangle_fan
	this.text		= text;
	this.font		= font;
	...
	this.render = function ()	
	{
		if (this.doRender)	{
			...
			/*outlet(0, "model 1 render triangle_fan");
			  outlet(0, "model 1 render line_loop");*/
	}
}
/*************************************/
/*************************************/

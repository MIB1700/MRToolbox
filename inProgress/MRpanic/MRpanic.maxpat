...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 82.0, 273.0, 322.0, 22.0 ],
					"style" : "",
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 385.0, 93.0, 84.0, 22.0 ],
					"style" : "",
					"text" : "patcherargs 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 82.0, 315.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "$1 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 82.0, 351.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "line 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 260.0, 108.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 181.0, 108.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 86.0, 108.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 260.0, 62.0, 83.0, 22.0 ],
					"style" : "",
					"text" : "MRkey return"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 181.0, 62.0, 70.0, 22.0 ],
					"style" : "",
					"text" : "MRkey esc"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 86.0, 62.0, 83.0, 22.0 ],
					"style" : "",
					"text" : "MRkey space"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 82.0, 402.0, 30.0, 30.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 373.0, 388.0, 145.0, 44.0 ],
					"viewvisibility" : 1
				}

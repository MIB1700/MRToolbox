...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 203.0, 122.0, 50.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 170.0, 76.0, 108.0, 18.0 ],
					"text" : "MRr_ #1 @r pluginVol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 872.0, 101.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 230.0, 168.0 ]
				}

			}
, 			{
				"box" : 				{
					"bkgndpict" : "sliderTrack2.pct",
					"bottommargin" : 1,
					"clickedimage" : 0,
					"id" : "obj-27",
					"inactiveimage" : 0,
					"knobpict" : "sliderKnob3.pct",
					"leftmargin" : 3,
					"leftvalue" : 127,
					"maxclass" : "pictslider",
					"movehorizontal" : 0,
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 168.0, 143.25, 19.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 14.75, 42.5, 19.0, 70.0 ],
					"rightmargin" : 3,
					"rightvalue" : 0,
					"topmargin" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 170.0, 222.0, 85.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 443.0, 246.0, 22.0, 140.0 ],
					"presentation_rect" : [ 423.5, 251.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 307.5, 246.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 257.5, 181.5, 50.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 537.0, 141.0, 54.0, 18.0 ],
					"text" : "delay 250"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 537.0, 111.5, 52.0, 18.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.5, 222.0, 93.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 288.5, 129.0, 48.0, 18.0 ],
					"text" : "route list"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 777.5, 628.0, 156.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 667.5, 628.0, 53.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 667.5, 598.0, 129.0, 21.0 ],
					"text" : "unpack 0 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 662.5, 653.0, 105.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 772.5, 653.0, 72.0, 21.0 ],
					"text" : "value (0-1)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 452.5, 546.0, 100.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 78.0, 78.5, 90.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 510.0, 628.0, 32.5, 18.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 510.0, 594.0, 125.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 14.75, 115.5, 59.5, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 375.0, 701.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 307.5, 701.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 668.5, 406.0, 45.0, 17.0 ],
					"text" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 393.5, 636.0, 101.0, 19.0 ],
					"text" : "prepend paramsIn"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 629.0, 406.0, 35.0, 17.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 393.5, 584.0, 52.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 170.0, 96.5, 40.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 393.5, 609.0, 68.0, 19.0 ],
					"text" : "pack f i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 578.0, 406.0, 48.0, 17.0 ],
					"text" : "params"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 307.5, 505.0, 289.0, 19.0 ],
					"text" : "plug"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 577.0, 168.75, 75.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 60.0, 42.5, 75.0, 19.0 ],
					"text" : "reload plugs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 537.0, 168.75, 41.5, 41.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 35.0, 42.5, 19.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1056.0, 354.0, 208.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 980.0, 332.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 980.0, 357.0, 61.0, 17.0 ],
					"text" : "bypass $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 959.5, 290.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 959.5, 315.0, 61.0, 17.0 ],
					"text" : "disable $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1056.0, 304.0, 142.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 795.0, 406.0, 74.0, 17.0 ],
					"text" : "presetnames"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 722.0, 406.0, 65.0, 17.0 ],
					"text" : "pgmnames"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 537.0, 248.0, 100.0, 19.0 ],
					"prefix" : "plug",
					"prefix_mode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 35.0, 61.5, 100.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 492.0, 222.0, 34.0, 17.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 495.75, 378.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 124.0, 140.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 495.75, 406.0, 61.0, 17.0 ],
					"text" : "bypass $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 537.0, 222.0, 93.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 688.5, 29.5, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 442.5, 29.5, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.5, 29.5, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 546.0, 613.0, 53.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 71.0, 115.5, 53.0, 19.0 ],
					"text" : "PRESET"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.0,
					"id" : "obj-57",
					"items" : [ "gain", ",", "azimuth", ",", "elevation", ",", "distance", ",", "coordinate scale", ",", "reference distance" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 442.5, 563.0, 125.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 78.0, 96.5, 90.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 495.75, 359.0, 54.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 142.0, 140.0, 54.0, 19.0 ],
					"text" : "BYPASS"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 629.0, 373.0, 18.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 142.0, 61.5, 18.0, 18.0 ],
					"trackhorizontal" : 1,
					"tracking" : 1,
					"trackvertical" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 616.5, 357.0, 43.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 157.0, 61.5, 43.0, 19.0 ],
					"text" : "OPEN"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 519.5, 648.0, 645.0, 648.0, 645.0, 501.0, 587.0, 501.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 298.0, 485.0, 587.0, 485.0 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 320.5, 395.0, 427.0, 395.0, 427.0, 234.0, 452.0, 234.0 ],
					"source" : [ "obj-4", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 316.5, 387.0, 317.0, 387.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 403.0, 664.0, 366.25, 664.0, 366.25, 495.0, 587.0, 495.0 ],
					"source" : [ "obj-48", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 989.5, 492.0, 587.0, 492.0 ],
					"source" : [ "obj-52", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 969.0, 482.0, 587.0, 482.0 ],
					"source" : [ "obj-54", 0 ]
				}
